...
#undef CS_STATE
    ...
    expr_symtab_add_field(symtab, "ct_proto", MFF_CT_NW_PROTO, "ct.trk", false);

    expr_symtab_add_predicate(symtab, "ct_udp", "ct_proto == 17");
    expr_symtab_add_field(symtab, "ct_udp.dst", MFF_CT_TP_DST, "ct_udp", false);
    expr_symtab_add_field(symtab, "ct_udp.src", MFF_CT_TP_SRC, "ct_udp", false);

    expr_symtab_add_predicate(symtab, "ct_tcp", "ct_proto == 6");
    expr_symtab_add_field(symtab, "ct_tcp.dst", MFF_CT_TP_DST, "ct_tcp", false);
    expr_symtab_add_field(symtab, "ct_tcp.src", MFF_CT_TP_SRC, "ct_tcp", false);
}
